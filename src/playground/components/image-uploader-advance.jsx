...
import ImageUploaderAdvance from '../../core/ui/image-uploader-advance'
...
const ImageUploaderAdvanceWrapper = ({id}) => {
...
ImageUploaderAdvanceWrapper.propTypes = {
  id: string,
}

export default memo(ImageUploaderAdvanceWrapper)
